...
"[project]/components/AdminAuditLogsClient.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminAuditLogsClient() {
    ...
    const fetchAuditLogs = async (page = 1, nextFilters = filters)=>{
        ...
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/api/admin/audit-logs`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                params: {
...
//# sourceMappingURL=components_09b547c2._.js.map