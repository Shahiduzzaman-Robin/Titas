...
"[project]/components/AdminGalleryClient.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminGalleryClient() {
    ...
    const fetchImages = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/api/gallery`);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/api/gallery`, data, {
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const token = localStorage.getItem('admin_token');
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API_BASE_URL}/api/gallery/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
_s(AdminGalleryClient, "KcUPh3Lkax5FKoiJbcaRKso7Sro=");
_c = AdminGalleryClient;
var _c;
__turbopack_context__.k.register(_c, "AdminGalleryClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_5b5895fb._.js.map