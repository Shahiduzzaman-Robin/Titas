...
"[project]/components/AdminSettingsClient.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminSettingsClient() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminSettingsClient.useEffect": ()=>{
            const fetchProfile = {
                "AdminSettingsClient.useEffect.fetchProfile": async ()=>{
                    try {
                        const token = localStorage.getItem('admin_token');
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/api/admin/profile`, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
            ...
            }["AdminSettingsClient.useEffect.fetchProfile"];
            fetchProfile();
        }
    }["AdminSettingsClient.useEffect"], []);
    const handleProfileSave = async (e)=>{
        ...
        try {
            const token = localStorage.getItem('admin_token');
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API_BASE_URL}/api/admin/profile`, profile, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handlePasswordChange = async (e)=>{
        ...
        try {
            const token = localStorage.getItem('admin_token');
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API_BASE_URL}/api/admin/change-password`, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    pwMsg.text && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AdminSettingsClient, "LVCL3vuV4vA2cWfvG1Oqx/jS/q0=");
_c = AdminSettingsClient;
var _c;
__turbopack_context__.k.register(_c, "AdminSettingsClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_11fd9964._.js.map