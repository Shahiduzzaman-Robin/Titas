...
const ContactForm = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setErrorMessage('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/api/contact`, formData);
            if (res.data.success) {
                setStatus('success');
                setFormData({
                    name: '',
...
_s(ContactForm, "zLR61lmw8DH8hA+fM2TQAFA4huI=");
_c = ContactForm;
...
//# sourceMappingURL=_e0e59426._.js.map