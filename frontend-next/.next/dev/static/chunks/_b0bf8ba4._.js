...
"[project]/components/ForgotPasswordClient.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ForgotPasswordClient() {
    _s();
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1); // 1: Email, 2: OTP, 3: New Password
    ...
    const handleSendOTP = async (e)=>{
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/api/students/forgot-password`, {
                email
            });
    ...
    const handleVerifyOTP = async (e)=>{
        ...
        setError('');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/api/students/verify-otp`, {
                email,
                otp
            });
            setStep(3);
    ...
    const handleResetPassword = async (e)=>{
        ...
        setError('');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/api/students/reset-password`, {
                email,
                otp,
                newPassword
            });
...
_s(ForgotPasswordClient, "NP8tuxoLoeELP4uuBjSKrJWeKao=", false, function() {
    return [
...
//# sourceMappingURL=_b0bf8ba4._.js.map