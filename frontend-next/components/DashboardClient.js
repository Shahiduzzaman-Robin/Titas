...
export default function DashboardClient() {
    ...
    const compactEmailBreakdown = Object.keys(EMAIL_CATEGORY_LABELS).map((category) => {
        ...
        return { category, sent, failed, total: sent + failed };
    });
        ...
        <div className="admin-layout">
            ...
            <div className="admin-main">
                ...
                <div className="platform-overview-grid">
                    <div className="platform-card" onClick={() => router.push('/admin/blog')}>
                    ...
                    <div className="platform-card" onClick={() => router.push('/admin/events')}>
                    ...
                    <div className="platform-card" onClick={() => router.push('/admin/gallery')}>
                    ...
                    <div className="platform-card" onClick={() => router.push('/admin/notices')}>
                    ...
                    <div className="platform-card" onClick={() => router.push('/admin/messages')}>
                    ...
                    <div className="platform-card" onClick={() => router.push('/admin/edits')}>
                ...
                <div className="demo-grid">
                    <div className="admin-card">
                        ...
                        <div className="dashboard-inline-action">
                            <button className="quick-action-btn quick-action-inline bn-text" onClick={() => router.push('/admin/audit-logs')}>
