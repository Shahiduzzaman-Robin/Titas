                ...
                <div className="footer-top">
                    ...
                    <div>
                        ...
                        <ul className="footer-links bn-text">
                            <li><Link href="/register">সদস্য রেজিস্ট্রেশন</Link></li>
                            <li><Link href="/students">সদস্য তালিকা</Link></li>
                            <li><Link href="/blog">আমাদের ব্লগ</Link></li>
                            <li><Link href="/contact">যোগাযোগ করুন</Link></li>
                            <li><Link href="/constitution">গঠনতন্ত্র</Link></li>
                        </ul>
                    </div>
