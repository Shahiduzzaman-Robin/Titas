...
const EditCard = ({ edit, onApprove, onReject }) => {
    ...
    // Parse changes — handle Mongoose Map (object) or plain object
        ...
        <div style={{
            ...
            {expanded && (
                <div style={{ padding: '1.25rem' }}>
                    <div style={{ marginBottom: '1rem' }}>
                        <div style={{
                            ...
                            {Object.entries(changes).map(([field, diff], i) => (
                                <>
                                    <div key={`label-${i}`} style={{ padding: '0.65rem 1rem', fontSize: '0.82rem', color: '#475569', fontWeight: 600, borderRight: '1px solid #e2e8f0', borderBottom: i < Object.keys(changes).length - 1 ? '1px solid #f1f5f9' : 'none', background: '#fafbfc' }} className="bn-text">
                                        {FIELD_LABELS[field] || field}
                                    </div>
                                    <div key={`old-${i}`} style={{ padding: '0.65rem 1rem', fontSize: '0.85rem', color: '#64748b', borderRight: '1px solid #e2e8f0', borderBottom: i < Object.keys(changes).length - 1 ? '1px solid #f1f5f9' : 'none', background: '#fafbfc' }} className="bn-text">
                                    ...
                                    <div key={`new-${i}`} style={{ padding: '0.65rem 1rem', fontSize: '0.85rem', color: '#1a1a2e', fontWeight: 600, borderBottom: i < Object.keys(changes).length - 1 ? '1px solid #f1f5f9' : 'none', background: '#fff' }} className="bn-text">
                    ...
                    {/* Review info for already-reviewed edits */}
                    {edit.status !== 'Pending' && (
    ...
    return (
        <div className="admin-layout">
            ...
            <div className="admin-main">
                ...
                {/* Stats strip - transformed to sleek tabs */}
