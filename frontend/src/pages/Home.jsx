                ...
                <div className="container">
                    ...
                    <div className="faq-list">
                        ...
                        <details className="faq-item">
                            ...
                            <div className="faq-content bn-text">
                                সাধারণত ২৪-৭২ ঘণ্টার মধ্যে আবেদন যাচাই করা হয়। প্রয়োজনীয় তথ্য (রেজিস্ট্রেশন নম্বর, বিভাগ, সেশন, যোগাযোগ নম্বর) সঠিক থাকলে দ্রুত অনুমোদন দেওয়া সম্ভব হয়। বিশেষ ব্যস্ত সময়ে একটু বেশি সময় লাগতে পারে।
                            </div>
                        </details>
