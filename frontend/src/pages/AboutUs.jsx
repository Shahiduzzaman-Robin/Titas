...
const AboutUs = () => {
    ...
    const committeeRef = useFadeIn();
    const timelineRef = useFadeIn();
    const constitutionRef = useFadeIn();
    ...
    return (
        <div className="about-page">
            ...
            <section className="about-hero" ref={heroRef}>
                ...
                <div className="container about-hero-content about-fade-up">
                    <img src={logo} alt="তিতাস লোগো" className="about-hero-logo" />
            ...
            {/* ═══════ 2. WHO WE ARE ═══════ */}
            <section className="about-section about-who" ref={whoRef}>
                <div className="container about-fade-up">
            ...
            {/* ═══════ 3. MISSION & VISION ═══════ */}
            <section className="about-section about-mission" ref={missionRef}>
                <div className="container about-fade-up">
                    <div className="about-section-header">
            ...
            {/* ═══════ 4. ACTIVITIES ═══════ */}
            <section className="about-section about-activities" ref={activitiesRef}>
                <div className="container about-fade-up">
                    <div className="about-section-header">
            ...
            {/* ═══════ 5. COMMITTEE ═══════ */}
            <section className="about-section about-committee" ref={committeeRef}>
                <div className="container about-fade-up">
                    <div className="about-section-header">
            ...
            {/* ═══════ 7. TIMELINE ═══════ */}
            <section className="about-section about-timeline" ref={timelineRef}>
                <div className="container about-fade-up">
                    <div className="about-section-header">
            ...
            {/* ═══════ 8. CONSTITUTION ═══════ */}
            <section className="about-section about-constitution" ref={constitutionRef}>
                <div className="container about-fade-up">
                    <div className="about-constitution-box">
                        <div className="about-constitution-content">
                            ...
                            <Link to="/constitution" className="about-constitution-btn">
                                <ScrollText size={18} />
