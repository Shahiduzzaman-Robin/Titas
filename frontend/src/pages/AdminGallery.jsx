...
import { Plus, Trash2, X, AlertCircle, Image as ImageIcon, Camera } from 'lucide-react';
...
const AdminGallery = () => {
    ...
    const openAddModal = () => {
        setFormData({ title: '', caption: '', category: 'Event' });
    ...
    return (
        <div className="admin-layout">
            ...
            <div className="admin-notices-content">
                <div className="notices-header">
                    <div className="header-info">
                        ...
                        <p className="en-text text-muted">Manage the photo gallery section on the homepage</p>
                    </div>
                        ...
                        {images.map(img => (
                            <div key={img._id} className="gallery-admin-card glass-panel">
                                <div className="card-image">
                                    ...
                                    <button className="delete-overlay" onClick={() => handleDelete(img._id)}>
                                        <Trash2 size={20} />
                                    </button>
                                </div>
                    ...
                    <div className="modal-content glass-panel">
                        ...
                        <form onSubmit={handleSubmit} className="notice-form">
                            ...
                            <div className="form-group">
                                <label className="bn-text">ছবির শিরোনাম *</label>
                                <input type="text" name="title" required className="modal-input bn-text" value={formData.title} onChange={handleInputChange} />
                            </div>

                            <div className="form-group">
                                <label className="bn-text">ক্যাপশন (সংক্ষিপ্ত)</label>
                                <input type="text" name="caption" className="modal-input bn-text" value={formData.caption} onChange={handleInputChange} />
                            </div>

                            <div className="form-group">
                                <label className="en-text">Category</label>
                                <select name="category" className="modal-input en-text" value={formData.category} onChange={handleInputChange}>
                            ...
                            <div className="modal-actions">
                                ...
                                <button type="submit" className="btn-modern-submit">Upload Photo</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <style>{`
                ...
                .gallery-admin-card:hover .delete-overlay {
                    opacity: 1;
                }
                .card-info {
                    padding: 0.8rem;
