            ...
            <div className="admin-main">
                ...
                <div className="asd-topbar">
                    <div className="asd-topbar-left">
                        <button className="asd-back-btn" onClick={() => navigate('/admin/students')}>
                            <ArrowLeft size={18} />
                        </button>
                        <div>
                ...
                <div className="asd-tabs">
                    <button className={`asd-tab bn-text ${activeTab === 'profile' ? 'active' : ''}`} onClick={() => setActiveTab('profile')}>প্রোফাইল এর্যালোনা</button>
                                ...
                                <div className="asd-card">
                                    ...
                                    <div className="asd-activities">
                                        {displayedActivities.map((act, idx) => {
                                            ...
                                            // Handle cases where details might be a Map/Object
                    ...
                    <div className="asd-id-tab">
                        <div className="asd-id-card-wrapper">
                            <div className="asd-id-front">
                                {/* Similar ID card design as in frontend if needed */}
